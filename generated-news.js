window.phoneRadarAuto = {
  ...
  "news": [
    ...
    },
    {
      ...
      "summary": "【小米澎程回应全系标配9个碰撞传感器：不追求数量，而是希望覆盖得更全面】 小米澎程全系布置了9个碰撞传感器，分别位于前防撞梁、前纵梁、前门、B柱以及C柱位置，覆盖车辆前部到乘员舱侧面的多个关键区域。 这样设计主要考虑的是，现实中的碰撞位置和碰撞方向非常复杂，通过在车身不同位置布置传感器，可以更充分地获取碰撞信息，更准确地识别碰撞发生的位置和方向，为安全气囊…",
      "tags": [
        "Xiaomi",
        "爆料",
        "酷安博主"
